...
import {formatDate, formatTemperature, getWeatherIcon} from "../utils/weatherutlis.js";
...
export default function WeatherForecast({forecast, unit}) {
    ...
    const dailyItems = Object.values(dailyForeast).slice(0, 5);
    {
                        ...
                        group-hover:scale-110 duration">
                            ...
                            <div className="flex items-center space-x-6">
                                ...
                                <div className="text-right">
                                    <div
                                        className="text-white font-bold text-xl">{formatTemperature(item.main.temp_max, unit)}°
                                    </div>
                                    <div
                                        className="text-white text-sm font-medium">{formatTemperature(item.main.temp_min, unit)}°
                                    </div>
                                </div>
                            </div>
                        </div>

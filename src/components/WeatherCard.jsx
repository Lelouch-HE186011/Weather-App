...
import {MapPin, Sunset, Sunrise, Droplets, Eye, Wind, Gauge, Thermometer} from "lucide-react";
import {formatTemperature, formatTime, getWeatherIcon} from "../utils/weatherutlis.js";
...
export default function WeatherCard({weather, unit}) {
    ...
    return (
        <div className="bg-white/10 backdrop-blure-xl border border-white/20 rounded-3xl p-8
            ...
            <div className="flex items-center justify-between mb-10">
                <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-4 text-white/60 text-sm">
                        ...
                        <span>L: {formatTemperature(weather.main.temp_min, unit)}°</span></div>
                </div>
